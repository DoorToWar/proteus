...
def main():
    ...
    cv2.putText(cropped, "Text on", (10, 10),cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 2)
    show_image(cropped,"image_fin")

    # сохранение изображения
    cv2.imwrite(r"C:\GOG Games\proteus\task 2\proteus\proteus\task3\data\save\image_fin.jpg", cropped)
